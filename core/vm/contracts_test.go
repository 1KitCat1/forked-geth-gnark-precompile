...
var allPrecompiles = map[common.Address]PrecompiledContract{
	...
	common.BytesToAddress([]byte{19}):   &groth16Verifier{},
}
...
func TestPrecompiledGroth16Verifier(t *testing.T)      { testJson("groth16Verifier", "13", t) }
func BenchmarkPrecompiledGroth16Verifier(b *testing.B) { benchJson("groth16Verifier", "13", b) }
