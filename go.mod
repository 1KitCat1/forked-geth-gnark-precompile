...
// We use dev version which is significantly more effective.
// Official gnark in develop has several issues, which are resolved in fork.
replace github.com/consensys/gnark => github.com/NikitaMasych/gnark v0.0.0-20230803161130-1b39379c29e3
