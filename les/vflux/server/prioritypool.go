...
type ppNodeInfo struct {
	...
	// default value when leaving the temp.json state
...
func (pp *priorityPool) setTempState(c *ppNodeInfo) {
	...
	// Assign all the defaults to the temp.json state.
...
// unsetTempState revokes the temp.json status of the node and reset all internal
